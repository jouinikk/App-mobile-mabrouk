    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String telStr = editTextTel.getText().toString(); // Récupérer la chaîne de caractères du numéro de téléphone
                if (telStr.isEmpty()) {
                    Toast.makeText(add_form.this, "Veuillez saisir un numéro de téléphone", Toast.LENGTH_SHORT).show();
                    return;
                }
                // Valider que la chaîne de caractères du numéro de téléphone contient uniquement des chiffres
                if (!telStr.matches("\\d+")) {
                    Toast.makeText(add_form.this, "Le numéro de téléphone ne doit contenir que des chiffres", Toast.LENGTH_SHORT).show();
                    return;
                }
                int tel = Integer.parseInt(telStr); // Convertir la chaîne de caractères en entier
                ...
                db.collection("User").add(newUser)
                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                Toast.makeText(add_form.this, "Utilisateur ajouté avec succès", Toast.LENGTH_SHORT).show();
                            }
                        });
