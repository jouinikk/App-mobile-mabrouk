...
public class detailsUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(detailsUser.this, MainActivity.class);
                startActivity(i);
            }
        });
    ...
    private void showEditUserDialog() {
        ...
        final Spinner spinnerUsers = view.findViewById(R.id.spinnerUser); // Ajoutez le Spinner des utilisateurs
        ...
        // Récupérez automatiquement la liste des utilisateurs en fonction du rôle du current user
        if ("commercial".equalsIgnoreCase(currentUser.getRole())) {
        ...
        builder.setPositiveButton("Enregistrer", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                // Retirez la récupération du rôle du Spinner de rôle
                User user = (User) spinnerUsers.getSelectedItem();
                String newCommercialAffecte = "";
                String newClientAffecte = "";
                String newRole = currentUser.getRole(); // Utilisez le rôle actuel du current user

                // Déterminez automatiquement le rôle affecté en fonction du rôle du current user
                if ("client".equalsIgnoreCase(currentUser.getRole())) {
                    newCommercialAffecte = user.getName();
                } else if ("commercial".equalsIgnoreCase(currentUser.getRole())) {
                    newClientAffecte = user.getName();
                }
